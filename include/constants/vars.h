...
#define VAR_REMAINING_FOSSIL                             0x408B
...
#define VAR_LEFT_FOSSIL                                  0x40DB
#define VAR_RIGHT_FOSSIL                                 0x40DC
...
#define VAR_RANDOMIZED_MOVE_TUTOR_MOVE_1                 0x40F7
#define VAR_RANDOMIZED_MOVE_TUTOR_MOVE_2                 0x40F8
#define VAR_RANDOMIZED_MOVE_TUTOR_MOVE_3                 0x40F9
#define VAR_RANDOMIZED_MOVE_TUTOR_MOVE_4                 0x40FA
#define VAR_LEVEL_CAP                                    0x40FB
