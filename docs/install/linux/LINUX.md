...
> ⚠️ **This is not** the correct installation path for Windows users running the Windows Subsystem for Linux (WSL). The page you're looking for is [here](../windows/WSL.md).
