...
{//   Item                        1+  11+  21+  31+  41+  51+  61+  71+  81+  91+   Levels
    { ITEM_TINY_MUSHROOM,     {  30,  10,   _,   _,   _,   _,   _,   _,   _,   _, } },
    { ITEM_TINY_BAMBOO_SHOOT, {  30,  10,   _,   _,   _,   _,   _,   _,   _,   _, } },
    { ITEM_BIG_BAMBOO_SHOOT,  {   8,  14,  15,   _,   _,   _,   _,   _,   _,   _, } },
    { ITEM_BIG_MUSHROOM,      {   8,  13,  15,   _,   _,   _,   _,   _,   _,   _, } },
