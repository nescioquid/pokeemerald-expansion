...
static const u8 sHustleDescription[] = _("Trades accuracy for Atk.");
...
static const u8 sTabletsOfRuinDescription[] = _("Lowers foes' Atk.");
static const u8 sBeadsOfRuinDescription[] = _("Lowers foes' Sp. Def.");
