...
static const struct TrainerMon sParty_Takao[] = {
    ...
    .moves = {MOVE_LOW_SWEEP, MOVE_SEISMIC_TOSS, MOVE_REVENGE, MOVE_KNOCK_OFF}
    }
};
...
static const struct TrainerMon sParty_Roxanne1[] = {
    ...
    .moves = {MOVE_TAIL_WHIP, MOVE_SCARY_FACE, MOVE_BULLDOZE, MOVE_ROCK_TOMB}
    },
    {
    .iv = TRAINER_PARTY_IVS(21, 21, 21, 21, 21, 21),
    .lvl = 10,
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_INGRAIN, MOVE_ANCIENT_POWER, MOVE_GIGA_DRAIN, MOVE_TICKLE}
    },
    {
    .iv = TRAINER_PARTY_IVS(21, 21, 21, 21, 21, 21),
    .lvl = 10,
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_FURY_CUTTER, MOVE_ROCK_TOMB, MOVE_ROCK_POLISH, MOVE_SCREECH}
    },
    {
    .iv = TRAINER_PARTY_IVS(21, 21, 21, 21, 21, 21),
    .lvl = 10,
    ...
    .species = SPECIES_SUDOWOODO,
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_FLAIL, MOVE_ROCK_TOMB, MOVE_BLOCK, MOVE_ROCK_POLISH}
    }
};
...
static const struct TrainerMon sParty_Brawly1[] = {
    ...
    .species = SPECIES_MACHOKE,
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_REVENGE, MOVE_KNOCK_OFF, MOVE_BULK_UP, MOVE_ROCK_SLIDE}
    },
    {
    .iv = TRAINER_PARTY_IVS(21, 21, 21, 21, 21, 21),
    .lvl = 15,
    ...
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_MEGA_DRAIN, MOVE_COUNTER, MOVE_MACH_PUNCH, MOVE_ROCK_SLIDE}
    },
    {
    .iv = TRAINER_PARTY_IVS(21, 21, 21, 21, 21, 21),
    .lvl = 15,
    ...
    .species = SPECIES_HITMONTOP,
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_TRIPLE_KICK, MOVE_COUNTER, MOVE_BULK_UP, MOVE_STONE_EDGE}
    },
};
...
static const struct TrainerMon sParty_Wattson1[] = {
    ...
    .moves = {MOVE_THUNDER_WAVE, MOVE_MAGNET_RISE, MOVE_SELF_DESTRUCT, MOVE_VOLT_SWITCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(21, 21, 21, 21, 21, 21),
    .lvl = 20,
    ...
    .species = SPECIES_AMPHAROS,
    .heldItem = ITEM_SHUCA_BERRY,
    .moves = {MOVE_THUNDER_WAVE, MOVE_THUNDER_PUNCH, MOVE_POWER_GEM, MOVE_VOLT_SWITCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(21, 21, 21, 21, 21, 21),
    .lvl = 20,
    ...
    .species = SPECIES_MAGNEZONE,
    .heldItem = ITEM_SHUCA_BERRY,
    .moves = {MOVE_THUNDER_WAVE, MOVE_METAL_SOUND, MOVE_FLASH_CANNON, MOVE_VOLT_SWITCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(21, 21, 21, 21, 21, 21),
    .lvl = 20,
    ...
    .heldItem = ITEM_SHUCA_BERRY,
    .moves = {MOVE_THUNDER_WAVE, MOVE_THUNDER_PUNCH, MOVE_VOLT_SWITCH, MOVE_ICE_PUNCH}
    }
};
...
static const struct TrainerMon sParty_Flannery1[] = {
    ...
    .species = SPECIES_MAGCARGO,
    .heldItem = ITEM_WHITE_HERB,
    .moves = {MOVE_ANCIENT_POWER, MOVE_LAVA_PLUME, MOVE_SHELL_SMASH, MOVE_ROCK_POLISH}
    },
    {
    .iv = TRAINER_PARTY_IVS(21, 21, 21, 21, 21, 21),
    .lvl = 25,
...
static const struct TrainerMon sParty_Norman1[] = {
    ...
    .moves = {MOVE_CONFUSE_RAY, MOVE_ZEN_HEADBUTT, MOVE_JUMP_KICK, MOVE_RETALIATE}
    },
    {
    .iv = TRAINER_PARTY_IVS(21, 21, 21, 21, 21, 21),
    .lvl = 25,
    ...
    .species = SPECIES_URSARING,
    .heldItem = ITEM_PINAP_BERRY,
    .moves = {MOVE_FACADE, MOVE_SWORDS_DANCE, MOVE_CLOSE_COMBAT, MOVE_CRUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(21, 21, 21, 21, 21, 21),
    .lvl = 25,
    ...
    .species = SPECIES_LINOONE,
    .heldItem = ITEM_PINAP_BERRY,
    .moves = {MOVE_PLAY_ROUGH, MOVE_BELLY_DRUM, MOVE_RETALIATE, MOVE_PURSUIT}
    },
    {
    .iv = TRAINER_PARTY_IVS(21, 21, 21, 21, 21, 21),
    .lvl = 25,
    ...
    .heldItem = ITEM_PINAP_BERRY,
    .moves = {MOVE_SLACK_OFF, MOVE_COUNTER, MOVE_RETALIATE, MOVE_PURSUIT}
    }
};
...
static const struct TrainerMon sParty_Josh[] = {
    ...
    .ability = ABILITY_STURDY,
    .species = SPECIES_GEODUDE,
    .moves = {MOVE_DEFENSE_CURL, MOVE_MAGNITUDE, MOVE_ROCK_THROW, MOVE_SMACK_DOWN}
    }
};
...
static const struct TrainerMon sParty_Tommy[] = {
    ...
    .ability = ABILITY_STURDY,
    .species = SPECIES_GEODUDE,
    .moves = {MOVE_ROCK_POLISH, MOVE_MAGNITUDE, MOVE_ROCK_THROW, MOVE_SMACK_DOWN}
    }
};
...
static const struct TrainerMon sParty_Quincy[] = {
    ...
    .moves = {MOVE_ASTONISH, MOVE_PROTECT, MOVE_WILL_O_WISP, MOVE_TOXIC}
    }
};
...
static const struct TrainerMon sParty_Eli[] = {
    ...
    .lvl = 23,
    .species = SPECIES_MACHOP,
    .moves = {MOVE_FIRE_PUNCH, MOVE_BULK_UP, MOVE_SMACK_DOWN, MOVE_NONE}
    }
};
...
static const struct TrainerMon sParty_BrendanRoute110Mudkip[] = {
    ...
    .moves = {MOVE_TOXIC_SPIKES, MOVE_THRASH, MOVE_BULLDOZE, MOVE_POISON_JAB}
    },
    {
    .iv = TRAINER_PARTY_IVS(21, 21, 21, 21, 21, 21),
    .lvl = 20,
    ...
    .heldItem = ITEM_CHILAN_BERRY,
    .moves = {MOVE_DRILL_RUN, MOVE_PLUCK, MOVE_PURSUIT, MOVE_STEEL_WING}
    },
    {
    .iv = TRAINER_PARTY_IVS(21, 21, 21, 21, 21, 21),
    .lvl = 20,
    ...
    .moves = {MOVE_NIGHT_SLASH, MOVE_LEAF_BLADE, MOVE_DUAL_CHOP, MOVE_ROCK_SLIDE}
    }
};
...
static const struct TrainerMon sParty_BrendanRoute119Mudkip[] = {
    ...
    .species = SPECIES_NIDOKING,
    .heldItem = ITEM_CHILAN_BERRY,
    .moves = {MOVE_TOXIC_SPIKES, MOVE_THRASH, MOVE_EARTHQUAKE, MOVE_SHADOW_CLAW}
    },
    {
    .iv = TRAINER_PARTY_IVS(21, 21, 21, 21, 21, 21),
    .lvl = 30,
    ...
    .species = SPECIES_SNORLAX,
    .heldItem = ITEM_PINAP_BERRY,
    .moves = {MOVE_RECYCLE, MOVE_YAWN, MOVE_BODY_SLAM, MOVE_BELCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(21, 21, 21, 21, 21, 21),
    .lvl = 30,
...
static const struct TrainerMon sParty_BrendanRoute110Torchic[] = {
    ...
    .species = SPECIES_SWAMPERT,
    .heldItem = ITEM_RINDO_BERRY,
    .moves = {MOVE_MUD_SHOT, MOVE_MUD_BOMB, MOVE_ROCK_SLIDE, MOVE_MUDDY_WATER}
    }
};
...
static const struct TrainerMon sParty_MayRoute110Mudkip[] = {
    ...
    .heldItem = ITEM_CHILAN_BERRY,
    .moves = {MOVE_TOXIC_SPIKES, MOVE_BODY_SLAM, MOVE_BULLDOZE, MOVE_POISON_JAB}
    },
    {
    .iv = TRAINER_PARTY_IVS(21, 21, 21, 21, 21, 21),
    .lvl = 20,
    ...
    .species = SPECIES_DODRIO,
    .heldItem = ITEM_CHILAN_BERRY,
    .moves = {MOVE_PURSUIT, MOVE_PLUCK, MOVE_TRI_ATTACK, MOVE_STEEL_WING}
    },
    {
    .iv = TRAINER_PARTY_IVS(21, 21, 21, 21, 21, 21),
    .lvl = 20,
    ...
    .species = SPECIES_CLEFAIRY,
    .heldItem = ITEM_CHILAN_BERRY,
    .moves = {MOVE_ENCORE, MOVE_COSMIC_POWER, MOVE_THUNDER_WAVE, MOVE_DAZZLING_GLEAM}
    },
    {
    .iv = TRAINER_PARTY_IVS(21, 21, 21, 21, 21, 21),
    .lvl = 20,
...
static const struct TrainerMon sParty_MayRoute119Mudkip[] = {
    ...
    .species = SPECIES_NIDOQUEEN,
    .heldItem = ITEM_CHILAN_BERRY,
    .moves = {MOVE_TOXIC_SPIKES, MOVE_BODY_SLAM, MOVE_EARTHQUAKE, MOVE_SHADOW_CLAW}
    },
    {
    .iv = TRAINER_PARTY_IVS(21, 21, 21, 21, 21, 21),
    .lvl = 30,
...
static const struct TrainerMon sParty_Marc[] = {
    ...
    .lvl = 8,
    .species = SPECIES_RHYHORN,
    .moves = {MOVE_FURY_ATTACK, MOVE_SCARY_FACE, MOVE_SMACK_DOWN, MOVE_STOMP}
    }
};
...
static const struct TrainerMon sParty_Cristian[] = {
    ...
    .lvl = 13,
    .species = SPECIES_BRELOOM,
    .moves = {MOVE_MACH_PUNCH, MOVE_MEGA_DRAIN, MOVE_STUN_SPORE, MOVE_COUNTER}
    }
};
...
static const struct TrainerMon sParty_BrendanRustboroTreecko[] = {
    ...
    .species = SPECIES_FEAROW,
    .heldItem = ITEM_CHILAN_BERRY,
    .moves = {MOVE_DRILL_RUN, MOVE_PLUCK, MOVE_PURSUIT, MOVE_AGILITY}
    },
    {
    .iv = TRAINER_PARTY_IVS(21, 21, 21, 21, 21, 21),
    .lvl = 10,
    ...
    .heldItem = ITEM_CHILAN_BERRY,
    .moves = {MOVE_DOUBLE_KICK, MOVE_FLAME_CHARGE, MOVE_QUICK_ATTACK, MOVE_ROCK_SLIDE}
    }
};
...
static const struct TrainerMon sParty_BrendanRustboroMudkip[] = {
    ...
    .heldItem = ITEM_CHILAN_BERRY,
    .moves = {MOVE_QUICK_ATTACK, MOVE_PURSUIT, MOVE_LEAF_BLADE, MOVE_ROCK_SLIDE}
    }
};
...
static const struct TrainerMon sParty_BrendanRustboroTorchic[] = {
    ...
    .heldItem = ITEM_CHILAN_BERRY,
    .moves = {MOVE_WATER_GUN, MOVE_MUD_SHOT, MOVE_MUD_BOMB, MOVE_ROCK_SLIDE}
    }
};
...
static const struct TrainerMon sParty_James1[] = {
    ...
    .lvl = 6,
    .species = SPECIES_BEEDRILL,
    .moves = {MOVE_TWINEEDLE, MOVE_FURY_ATTACK, MOVE_RAGE, MOVE_VENOSHOCK}
    }
};
...
static const struct TrainerMon sParty_LeaAndJed[] = {
    ...
    .ability = ABILITY_FLASH_FIRE,
    .species = SPECIES_RAPIDASH,
    .moves = {MOVE_FLARE_BLITZ, MOVE_WILD_CHARGE, MOVE_SOLAR_BEAM, MOVE_SUNNY_DAY}
    },
    {
    .lvl = 45,
    .ability = ABILITY_SOLAR_POWER,
    .species = SPECIES_SUNFLORA,
    .moves = {MOVE_GIGA_DRAIN, MOVE_LEECH_SEED, MOVE_SOLAR_BEAM, MOVE_SUNNY_DAY}
    }
};
...
static const struct TrainerMon sParty_Vivian[] = {
    ...
    .lvl = 17,
    .species = SPECIES_MANKEY,
    .moves = {MOVE_THUNDER_PUNCH, MOVE_FOCUS_ENERGY, MOVE_NONE, MOVE_NONE}
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 17,
    .species = SPECIES_HITMONCHAN,
    .moves = {MOVE_THUNDER_PUNCH, MOVE_AGILITY, MOVE_NONE, MOVE_NONE}
    }
};
...
static const struct TrainerMon sParty_Danielle[] = {
    ...
    .lvl = 23,
    .species = SPECIES_PRIMEAPE,
    .moves = {MOVE_FIRE_PUNCH, MOVE_FOCUS_ENERGY, MOVE_NONE, MOVE_NONE}
    }
};
...
static const struct TrainerMon sParty_Keigo[] = {
    ...
    .lvl = 28,
    .species = SPECIES_NINJASK,
    .moves = {MOVE_SAND_ATTACK, MOVE_NONE, MOVE_FURY_CUTTER, MOVE_SWORDS_DANCE}
    }
};
...
static const struct TrainerMon sParty_BrendanLilycoveMudkip[] = {
    ...
    .heldItem = ITEM_CHILAN_BERRY,
    .moves = {MOVE_ACROBATICS, MOVE_SWORDS_DANCE, MOVE_EARTHQUAKE, MOVE_U_TURN}
    },
    {
    .iv = TRAINER_PARTY_IVS(21, 21, 21, 21, 21, 21),
    .lvl = 40,
    ...
    .species = SPECIES_CLEFABLE,
    .heldItem = ITEM_CHILAN_BERRY,
    .moves = {MOVE_ENCORE, MOVE_MOONBLAST, MOVE_PSYCHIC, MOVE_FLAMETHROWER}
    },
    {
    .iv = TRAINER_PARTY_IVS(21, 21, 21, 21, 21, 21),
    .lvl = 40,
    ...
    .species = SPECIES_SNORLAX,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_BODY_SLAM, MOVE_BELCH, MOVE_BELLY_DRUM, MOVE_RECYCLE}
    },
    {
    .iv = TRAINER_PARTY_IVS(21, 21, 21, 21, 21, 21),
    .lvl = 40,
    ...
    .species = SPECIES_ARCANINE,
    .heldItem = ITEM_CHILAN_BERRY,
    .moves = {MOVE_THUNDER_FANG, MOVE_EXTREME_SPEED, MOVE_CRUNCH, MOVE_FLARE_BLITZ}
    },
    {
    .iv = TRAINER_PARTY_IVS(21, 21, 21, 21, 21, 21),
    .lvl = 40,
...
static const struct TrainerMon sParty_BrendanLilycoveTreecko[] = {
    ...
    .species = SPECIES_BLAZIKEN,
    .heldItem = ITEM_CHILAN_BERRY,
    .moves = {MOVE_BLAZE_KICK, MOVE_SKY_UPPERCUT, MOVE_SWORDS_DANCE, MOVE_ROCK_SLIDE}
    }
};
...
static const struct TrainerMon sParty_BrendanLilycoveTorchic[] = {
    ...
    .species = SPECIES_SWAMPERT,
    .heldItem = ITEM_CHILAN_BERRY,
    .moves = {MOVE_ROCK_SLIDE, MOVE_MUDDY_WATER, MOVE_TAKE_DOWN, MOVE_EARTHQUAKE}
    }
};
...
static const struct TrainerMon sParty_Roxanne2[] = {
    ...
    .species = SPECIES_SUDOWOODO,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_NONE, MOVE_EXPLOSION, MOVE_PROTECT, MOVE_ROCK_SLIDE}
    }
};
...
static const struct TrainerMon sParty_Brawly2[] = {
    ...
    .lvl = 37,
    .species = SPECIES_POLIWRATH,
    .moves = {MOVE_BELLY_DRUM, MOVE_HYPNOSIS, MOVE_FOCUS_PUNCH, MOVE_WATERFALL}
    }
};
...
static const struct TrainerMon sParty_Flannery2[] = {
    ...
    .species = SPECIES_NINETALES,
    .heldItem = ITEM_WHITE_HERB,
    .moves = {MOVE_OVERHEAT, MOVE_SUNNY_DAY, MOVE_ENERGY_BALL, MOVE_ATTRACT}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 40,
    .species = SPECIES_MAGMORTAR,
    .heldItem = ITEM_WHITE_HERB,
    .moves = {MOVE_OVERHEAT, MOVE_SUNNY_DAY, MOVE_SOLAR_BEAM, MOVE_THUNDERBOLT}
    }
};
...
static const struct TrainerMon sParty_Norman2[] = {
    ...
    .lvl = 42,
    .species = SPECIES_STANTLER,
    .moves = {MOVE_CONFUSE_RAY, MOVE_PSYSHOCK, MOVE_HYPNOSIS, MOVE_RETALIATE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 42,
    .species = SPECIES_CHANSEY,
    .moves = {MOVE_LIGHT_SCREEN, MOVE_SING, MOVE_SOFT_BOILED, MOVE_FOCUS_PUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 43,
    ...
    .species = SPECIES_SLAKING,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_GIGA_IMPACT, MOVE_HAMMER_ARM, MOVE_ROCK_SLIDE, MOVE_SLACK_OFF}
    }
};
...
static const struct TrainerMon sParty_Norman5[] = {
    ...
    .lvl = 57,
    .species = SPECIES_BLISSEY,
    .moves = {MOVE_PROTECT, MOVE_SING, MOVE_SOFT_BOILED, MOVE_FOCUS_PUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 55,
...
static const struct TrainerMon sParty_Winona2[] = {
    ...
    .lvl = 38,
    .species = SPECIES_FEAROW,
    .moves = {MOVE_PURSUIT, MOVE_AERIAL_ACE, MOVE_ASSURANCE, MOVE_ROOST}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 41,
...
static const struct TrainerMon sParty_Juan2[] = {
    ...
    .lvl = 46,
    .species = SPECIES_WHISCASH,
    .moves = {MOVE_RAIN_DANCE, MOVE_WATER_PULSE, MOVE_NONE, MOVE_FISSURE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 48,
    ...
    .species = SPECIES_KINGDRA,
    .heldItem = ITEM_CHESTO_BERRY,
    .moves = {MOVE_WATER_PULSE, MOVE_NONE, MOVE_ICE_BEAM, MOVE_REST}
    }
};
