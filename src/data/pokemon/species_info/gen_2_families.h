...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_MEGANIUM] =
    {
        ...
        .baseSpAttack  = 83,
        .baseSpDefense = 100,
        .types = MON_TYPES(TYPE_GRASS, TYPE_FAIRY), // ADDED FAIRY TYPING
        .catchRate = 45,
...
#define AMPHAROS_DEFENSE (P_UPDATED_STATS >= GEN_6 ? 85 : 75)
    ...
    [SPECIES_SUNFLORA] =
    {
        ...
        .baseSpAttack  = 105,
        .baseSpDefense = 85,
        .types = MON_TYPES(TYPE_GRASS, TYPE_FIRE), //Ttime100 added Fire typing
        .catchRate = 120,
    ...
    [SPECIES_YANMEGA] =
    {
        ...
        .baseSpAttack  = 116,
        .baseSpDefense = 56,
        .types = MON_TYPES(TYPE_BUG, TYPE_DRAGON), // CHANGED TYPING FROM FLYING TO DRAGON
        .catchRate = 30,
    ...
    [SPECIES_MISDREAVUS] =
    {
        ...
        .baseSpAttack  = 85,
        .baseSpDefense = 85,
        .types = MON_TYPES(TYPE_GHOST, TYPE_FAIRY), // ADDED FAIRY TYPING
        .catchRate = 45,
...
#define CORSOLA_DEFENSES (P_UPDATED_STATS >= GEN_7 ? 95 : 85)
    ...
    [SPECIES_CELEBI] =
    {
        ...
        .baseSpAttack  = 100,
        .baseSpDefense = 100,
        .types = MON_TYPES(TYPE_FAIRY, TYPE_GRASS), // CHANGED TYPING FROM PSYCHIC TO FAIRY
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 300,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
