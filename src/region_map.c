...
static const mapsec_u16_t sRegionMap_SpecialPlaceLocations[][2] =
{
    ...
    {MAPSEC_PETALBURG_WOODS,            MAPSEC_ROUTE_104_SOUTH},
...
static const u8 sMapHealLocations[][3] =
{
    ...
    [MAPSEC_ROUTE_104_NORTH] = {MAP_GROUP(MAP_ROUTE104NORTH), MAP_NUM(MAP_ROUTE104NORTH), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_104_SOUTH] = {MAP_GROUP(MAP_ROUTE104SOUTH), MAP_NUM(MAP_ROUTE104SOUTH), HEAL_LOCATION_NONE},
    ...
    [MAPSEC_SHADESPUR_ISLE] = {MAP_GROUP(MAP_SHADESPUR_ISLE), MAP_NUM(MAP_SHADESPUR_ISLE), HEAL_LOCATION_SHADESPUR_ISLE}, //Ttime100 added
    [MAPSEC_STARFALL_GLACIER] = {MAP_GROUP(MAP_STARFALL_GLACIER), MAP_NUM(MAP_STARFALL_GLACIER), HEAL_LOCATION_NONE}, //Ttime100 added
};
...
static const mapsec_u16_t sRedOutlineFlyDestinations[][2] =
{
    ...
    {
        FLAG_LANDMARK_SHADESPUR_ISLE,
        MAPSEC_SHADESPUR_ISLE
    },
    {
        -1,
        MAPSEC_NONE
...
static u8 GetMapsecType(mapsec_u16_t mapSecId)
{
    ...
    case MAPSEC_SHADESPUR_ISLE:
        return FlagGet(FLAG_LANDMARK_SHADESPUR_ISLE) ? MAPSECTYPE_BATTLE_FRONTIER : MAPSECTYPE_NONE; //Ttime100 added
    case MAPSEC_STARFALL_GLACIER:
        return FlagGet(FLAG_LANDMARK_STARFALL_GLACIER) ? MAPSECTYPE_ROUTE : MAPSECTYPE_NONE; //Ttime100 added
    default:
